...
output2 = Update_Gamma_Beta_Theta(5000, 3, W, y, x, ExpU, InititalValues, Eit, UpdateTheta = FALSE, UpdatePsi = TRUE)
...
save(output1.list, output2.list, data.list, file = paste(path, "/thesisCode/Simulation/thetaComp_300rep.RData", sep = ""))
## DIC
source(paste(path,"/thesisCode/Simulation/DIC_calculation.R", sep = ""))
load(paste(path, "/thesisCode/Simulation/thetaComp.RData", sep = ""))
